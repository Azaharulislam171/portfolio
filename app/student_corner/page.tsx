...
const page = () => {
 ...
 <>
 <FloatingNavDemo/>
 <section id="classOf2024">
 <div className='md:mx-12 lg:mx:16s'>
  <h2 className='  text-5xl font-bold notable-headings m-4 tracking-widest underline underline-offset-4 py-5'> Graduating Class of 2025</h2>
  <div className="m-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    {students2025.map(student => (
      <div key={student.id} className="bg-inherit border-2  p-6 rounded-xl shadow-lg">
            ...
            <div className="relative group w-full h-80 flex justify-end">
                ...
                <div className="absolute inset-0 bg-white dark:bg-black  flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="text-center ">
                    <h2 className="text-5xl  font-bold notable-headings  my-1 ms-2">{student.first_name}</h2>
                    <h2 className="text-5xl   flex justify-end  font-bold notable-headings  my-1 ms-2">{student.last_name}</h2>
                  </div>
                </div>
            </div>
        ...
        <p className="font-serif  ">{student.intro}</p>
      </div>
    ))}
  </div>
</div>
 ...
 <div className='md:mx-12 lg:mx:16s'>
  <h2 className='   text-5xl font-bold notable-headings m-4 tracking-widest underline underline-offset-4 py-5'> Graduating Class of 2024</h2>
  <div className="m-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
