...
const page = () => {
 ...
 <div className='md:mx-12 lg:mx:16s'>
  <h2 className='  text-5xl font-serif text-center m-4 tracking-widest underline underline-offset-4'> Graduating Class of 2025</h2>
 ...
 <div className='md:mx-12 lg:mx:16s'>
  <h2 className='  text-5xl font-serif text-center m-4 tracking-widest underline underline-offset-4'> Graduating Class of 2024</h2>
  <div className="m-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
